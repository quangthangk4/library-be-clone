...
@Slf4j
@Component
@Order(3) // Run after RoleDataInitializer (which has default order = 1)
...
public class StudentAccountInitializer implements CommandLineRunner {
    ...
    private static final String ADMIN_EMAIL = "student@hcmut.edu.vn";
    private static final String ADMIN_PASSWORD = "student";
    ...
    private void initializeAdminAccount() {
        ...
        // Get ADMIN role
        Role adminRole = roleRepository.findByName("STUDENT")
